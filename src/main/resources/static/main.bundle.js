...
var Task = (function () {
    function Task(name, complete, dueDate) {
        this.name = name;
...
var TaskService = (function () {
    ...
    TaskService.prototype.save = function (task, checked) {
...
var TasksAddComponent = (function () {
    ...
    TasksAddComponent.prototype.onTaskAdd = function (event) {
        var _this = this;
        var task = new __WEBPACK_IMPORTED_MODULE_1__task_model__["a" /* Task */](event.target.value, false, '10/04/2018');
